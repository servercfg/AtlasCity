TokoVoipConfig = {
	...
	keyProximity = Keys["PAGEUP"], -- Keybind used to switch the proximity mode
    ...
    wsServer = "78.46.193.237:11186", -- Address of the websocket server
	...
	plugin_data = {
		...
		TSChannel = "SERVER_1",
		TSPassword = "43ijsidiu3hjksxndjsjhnik33sk", -- TeamSpeak channel password (can be empty)
		...
		TSChannelWait = "[TokoVOIP] Venterum",

		-- Blocking screen informations
		TSServer = "Backsiderp.swifthosting.dk", -- TeamSpeak server address to be displayed on blocking screen
