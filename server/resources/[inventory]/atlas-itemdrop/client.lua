...
local props = {
    ...
    ["wbody|WEAPON_CARBINERIFLE"]={prop='w_ar_carbinerifle', rot=90.0},
    ["wbody|WEAPON_SNIPERRIFLE"]={prop='w_sr_sniperrifle', rot=90.0},
    ["wbody|WEAPON_ASSAULTRIFLE"]={prop='w_ar_assaultrifle', rot=90.0},
    ["wbody|WEAPON_SPECIALCARBINE"]={prop='w_ar_specialcarbine', rot=90.0},
    ["wbody|WEAPON_SMG"]={prop='w_sb_smg', rot=90.0},
    ["wbody|WEAPON_STUNGUN"]={prop='w_pi_stungun', rot=90.0},
    ["wbody|WEAPON_COMBATPISTOL"]={prop='W_PI_COMBATPISTOL', rot=90.0},
    ["wbody|WEAPON_STUNGUN"]={prop='w_pi_stungun', rot=90.0},
    ...
    ["dirty_money"]={prop='prop_cash_case_01', rot=0.0,size={[1]='prop_anim_cash_note_b',[10000]='prop_cash_pile_02',[50000]='prop_cs_heist_bag_01',[100000]='prop_cash_case_01',[1000000]='prop_cash_crate_01'}},
    ["default"]={prop='prop_med_bag_01b', rot=0.0},
    ["iphone"]={prop='prop_player_phone_01', rot=0.0},
    ["samsung"]={prop='prop_player_phone_01', rot=0.0},
    ["oneplus"]={prop='prop_player_phone_01', rot=0.0},
    ["computer"]={prop='prop_player_phone_01', rot=0.0},
    ...
    ["kokain"]={prop='prop_coke_block_01', rot=90.0,size={[1]='prop_coke_block_01',[50000]='prop_cs_heist_bag_01'}},
...
RegisterNetEvent('atlas-itemdrop:load')
AddEventHandler('atlas-itemdrop:load', function(list)
    bags = list
    for k,v in pairs(list) do
        TriggerEvent('atlas-itemdrop:create',v,k)
    end
end)

RegisterNetEvent('atlas-itemdrop:create')
AddEventHandler('atlas-itemdrop:create', function(bag,count)
    bags[count] = bag
...
RegisterNetEvent('atlas-itemdrop:update')
AddEventHandler('atlas-itemdrop:update', function(count,bag)
    bags[count] = bag
end)

RegisterNetEvent('atlas-itemdrop:remove')
AddEventHandler('atlas-itemdrop:remove', function(count)
        ...
        for k,v in pairs(bags) do
            ...
            if distance <= 2.0 then
                ...
                if IsControlJustPressed(0, Keys["E"]) then
                    ...
                    TriggerServerEvent("atlas-itemdrop:pickup",k)
                end
            end
        end
