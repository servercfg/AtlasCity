...
function transfer(fPlayer, tPlayer, amount)
    ...
    PerformHttpRequest('https://discordapp.com/api/webhooks/773266657534935090/wooYsiBBQpldGhOSXhiKtbHZ7B8IO1u5lTS1UQHL064URi3ekn_0NnvpZuAtkc7Hae07', function(err, text, headers) end, 'POST', json.encode({username = "Bank Logs", content = "**ID: "..user_id.."** overførte "..math.floor(amount).."DKK til "..user_id2}), { ['Content-Type'] = 'application/json' })
...
AddEventHandler('bank:depositAll', function()
    ...
    if(wallet > 0) then
        ...
        PerformHttpRequest('https://discordapp.com/api/webhooks/773270393745702922/BvVEQ7rF1We_SEs4vq9IZBL8iDhWDWFCBJMyFp4XH22aQmgAgXlQxkiY1oSApYvvA5-b', function(err, text, headers) end, 'POST', json.encode({username = "Bank Logs", content = "**ID: "..user_id.." ** indsatte "..rounded.."DKK til sin konto"}), { ['Content-Type'] = 'application/json' })
...
AddEventHandler('bank:deposit', function(amount)
    ...
    if(rounded <= wallet) then
        ...
        PerformHttpRequest('https://discord.com/api/webhooks/773270393745702922/BvVEQ7rF1We_SEs4vq9IZBL8iDhWDWFCBJMyFp4XH22aQmgAgXlQxkiY1oSApYvvA5-b', function(err, text, headers) end, 'POST', json.encode({username = "Bank Logs", content = "**ID: "..user_id.." ** indsatte "..rounded.."DKK til sin konto"}), { ['Content-Type'] = 'application/json' })
        TriggerClientEvent("pNotify:SendNotification", source, {
            text = "Du indsatte <b style='color: #4E9350'>"..format_thousand(math.floor(rounded)).." DKK</b>.",
            type = "success",
            timeout = (4000),
...
AddEventHandler('bank:withdraw', function(amount)
    ...
    if(tonumber(rounded) <= tonumber(bankbalance)) then
        ...
        PerformHttpRequest('https://discordapp.com/api/webhooks/773270393745702922/BvVEQ7rF1We_SEs4vq9IZBL8iDhWDWFCBJMyFp4XH22aQmgAgXlQxkiY1oSApYvvA5-b', function(err, text, headers) end, 'POST', json.encode({username = "Bank Logs", content = "**ID: "..user_id.." ** hævede "..rounded.."DKK fra sin konto"}), { ['Content-Type'] = 'application/json' })
        TriggerClientEvent("pNotify:SendNotification", source, {
