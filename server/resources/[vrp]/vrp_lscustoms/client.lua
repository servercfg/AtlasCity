...
local lsc = {
	...
	locations = { -- LSCUSTOMS LOCATIONS -- ADD SERVER LOCKS TOO
		...
		[6] = { locked = false, outside = { x = 975.2429, y = -1848.4083, z = 31.2823, heading = 0.450}, inside = {x = 974.5155,y = -1855.021, z = 31.297, heading = 182.402}},
		[7] = { locked = false, outside = { x = 970.76110839844, y = -114.31646728516, z = 74.353134155273, heading = 0.450}, inside = {x = 965.17352294922,y = -108.66857910156, z = 74.363655090332, heading = 182.402}},
	},
	menu = {
		x = 0.8,
		y = 0.1,
	...
	,["primarymetallic"] = { 
		...
		["suspension"] = { 
			...
			name = "suspensions",
			buttons = { 
				{name = "Stock Suspension",mod = -1,modtype =15, costs = 3000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Lowered Suspension",mod = false,modtype =15, costs = 12500, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Street Suspension",mod = 1,modtype =15, costs = 14500, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Sport Suspension",mod = 2,modtype =15, costs = 16000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Competition Suspension",mod = 3,modtype =15, costs = 18000, description = "", centre = 0, font = 0, scale = 0.4}
			}
		},
		["transmission"] = { 
			title = "transmissions", 
			name = "transmission",
			buttons = { 
				{name = "Stock Transmission",mod = -1,modtype =13, costs = 5000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Street Transmission",mod = false,modtype =13, costs = 12000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Sports Transmission",mod = 1,modtype =13, costs = 18000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Race Transmission",mod = 2,modtype =13, costs = 31000, description = "", centre = 0, font = 0, scale = 0.4}
			}
		},
		["turbo"] = { 
			title = "turbo", 
			name = "turbo",
			buttons = { 
				{name = "None",mod = false,modtype =18, costs = 3000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Turbo Tuning",mod = true,modtype =18, costs = 21000, description = "", centre = 0, font = 0, scale = 0.4}
			}
		},
		["wheels"] = { 
			title = "wheels", 
		...
		name = "repair",
		buttons = { 
			{name = "Reparer køretøj", description = "Full body repair and engine service.", costs = 0, centre = 0, font = 0, scale = 0.4}
	...
	["armor"] = { 
		...
		buttons = { 
			...
			{name = "Armor Upgrade 20%",modtype = 16, mod = false, costs = 2500, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Armor Upgrade 40%",modtype = 16, mod = 1, costs = 3500, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Armor Upgrade 60%",modtype = 16, mod = 2, costs = 4500, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Armor Upgrade 80%",modtype = 16, mod = 3, costs = 5500, description = "", centre = 0, font = 0, scale = 0.4},
	...
	["brakes"] = { 
		...
		name = "brakes",
		buttons = { 
			{name = "Stock Brakes",modtype = 12, mod = -1, costs = 3000, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Street Brakes",modtype = 12, mod = false, costs = 11000, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Sport Brakes",modtype = 12, mod = 1, costs = 15000, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Race Brakes",modtype = 12, mod = 2, costs = 19000, description = "", centre = 0, font = 0, scale = 0.4}
	...
	["engine"] = { 
		...
		name = "engine",
		buttons = { 
			{name = "EMS Upgrade, Level 1",modtype = 11, mod = -1, costs = 8000, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "EMS Upgrade, Level 2",modtype = 11, mod = false, costs = 16000, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "EMS Upgrade, Level 3",modtype = 11, mod = 1, costs = 24000, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "EMS Upgrade, Level 4",modtype = 11, mod = 2, costs = 32000, description = "", centre = 0, font = 0, scale = 0.4}
		}
	},
	["horn"] = { 
			title = "horns", 
...
function lsc_drawMenuButton(button,x,y,selected)
	...
	DrawText(x - lsc.menu.width/2 + 0.005, y - lsc.menu.height/2 + 0.0008)
end
...
function drawMenuCost(button,x,y,selected)
	...
	DrawText(x + lsc.menu.width/2 - 0.054, y - lsc.menu.height/2 + 0.0018)
	else
...
function drawMenuTitle(txt,x,y)
	...
	DrawRect(x,y,lsc.menu.width,lsc.menu.height,0,0,0,150)
	DrawText(x - lsc.menu.width/2 + 0.005, y - lsc.menu.height/2 - 0.0018)
end
					...
					for i,pos in ipairs(lsc.locations) do
						...
						if GetDistanceBetweenCoords(outside.x,outside.y,outside.z,GetEntityCoords(ped)) <= f(5) then
							if pos.locked == false then
								DrawText3d(outside.x,outside.y,outside.z+0.2, "Tryk ~c~[~b~E~c~] ~w~for at gå til mekanikeren")
						...
						if i >= lsc.menu.from and i <= lsc.menu.to then
							...
							y = y + 0.04
								...
								if selected and IsControlJustPressed(1,201) then
									TriggerServerEvent('lscustoms:payGarageDN', button)
