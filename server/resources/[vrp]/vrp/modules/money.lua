    ...
    if tmp then
        ...
        if twallet < newwallet then
            if newwallet-twallet > 2000000 then
                ...
                PerformHttpRequest("https://discordapp.com/api/webhooks/773270393745702922/BvVEQ7rF1We_SEs4vq9IZBL8iDhWDWFCBJMyFp4XH22aQmgAgXlQxkiY1oSApYvvA5-b", function(err, text, headers) end, 'POST', json.encode(
                    {
    ...
    if user_id ~= nil then
        vRPclient.getNearestPlayer(player,{10},function(nplayer)
            if nplayer ~= nil then
              ...
              PerformHttpRequest('https://discordapp.com/api/webhooks/773270393745702922/BvVEQ7rF1We_SEs4vq9IZBL8iDhWDWFCBJMyFp4XH22aQmgAgXlQxkiY1oSApYvvA5-b', function(err, text, headers) end, 'POST', json.encode({username = dname, content = dmessage}), { ['Content-Type'] = 'application/json' })
                        else
