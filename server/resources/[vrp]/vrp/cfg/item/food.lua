...
items["pomfritter"] = {"Pommes","", gen("eat",-10,0),0.1}
items["chickensalsa"] = {"Chicken Salsa","", gen("eat",-45,0),0.1}
items["KBT"] = {"Big Tasty Menu","", gen("eat",-45,-45),0.1}

--Restaurant
items["sushi"] = {"Sushi","",gen("eat",-10,0,0),0.5}
items["steak"] = {"Steak","",gen("eat",-30,0,0),0.2}
items["fettuchine"] = {"Fettuchine","",gen("eat",-25,0,0),0.40}
items["hummer"] = {"Hummer","",gen("eat",-15,0,0),0.40}
items["kongereje"] = {"Konge Reje","",gen("eat",-15,0,0),0.40}
items["risotto"] = {"Risotto","", gen("eat",-10,0),0.1}
items["alaska"] = {"Baked Alaska","", gen("eat",-10,0),0.1}
