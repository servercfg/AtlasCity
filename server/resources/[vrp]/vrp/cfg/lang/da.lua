...
local lang = {
  common = {
    welcome = "<b style='color:#0099ff'>Velkommen til BacksideRP</b><br /><br /><br >Herinde på BacksideRP kører vi med content-baseret RP med dansk tema. Dette betyder at der ikke er så stramme regler på vores server. men der er stadig regler som skal følges. (Som du finder på vores hjemmeside under regler).<br /><br />Vi fra AltasCity ønsker at du får et behageligt ophold i byen, og at du skaber en karakter, som du kommer til at være stolt af.<br /><br style='color:#e0099ff'/>Husk at være tilsluttet vores discord for at se mere fra BacksideRP, samt kommende opdateringer.",
  ...
  police = {
    ...
    menu = {
      ...
      seize = {
        ...
        radio = {
          title = "Beslaglægt alt kommunikation",
          description = "Tager radio og telefoner.",
          seized = "Din radio og telefon er blevet taget."
        }
      },
      jail = {
        title = "Fængsel",
  ...
  funktioner = {
    ...
    directory = {
      title = "Funktioner",
      description = "Diverse funktioner.",
      },
   menu = {
    pose = {
      title = "Fjern Pose",
      description = "Fjerner posen.",
      },
      pose2 = {
        title = "Tag Pose",
        description = "Sætter pose på hovedet på den nærmeste person.",
        }
    }
    },
    journalist = {
  ...
  menu = {
    kamera = {
      title = "Kamera",
      description = "Tag billeder.",
    },
    videokamera = {
      title = "VideoKamera",
      description = "Optag video.",
    },
    mikrofon = {
      title = "Mikrofon",
      description = "Optag lyd.",
    },
    boommikrofon = {
      title = "BoomMikrofon",
      description = "Optag lyd.",
