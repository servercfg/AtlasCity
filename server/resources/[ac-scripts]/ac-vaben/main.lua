	...
	while true do
		...
		for i=1, #Config.RealWeapons, 1 do
    		...
    		if HasPedGotWeapon(playerPed, weaponHash, false) then
				...
				GiveWeaponComponentToPed(playerPed, GetHashKey("WEAPON_CARBINERIFLE"), GetHashKey("COMPONENT_AT_AR_SUPP"))
                -- SMG magasin, lys samt camo.
                GiveWeaponComponentToPed(playerPed, GetHashKey("WEAPON_SMG"), GetHashKey("COMPONENT_AT_SCOPE_MACRO_02"))
				GiveWeaponComponentToPed(playerPed, GetHashKey("WEAPON_SMG"), GetHashKey("COMPONENT_AT_AR_FLSH"))
				GiveWeaponComponentToPed(playerPed, GetHashKey("WEAPON_SMG"), GetHashKey("COMPONENT_AT_SCOPE_MACRO"))
                -- Finskytte sigte
