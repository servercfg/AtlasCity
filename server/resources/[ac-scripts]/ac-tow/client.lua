...
local allowedTowModels = { 
    ...
    ['flatbed3'] = {x = 0.0, y = -0.85, z = 2.00}, -- addon flatbed2
}
...
AddEventHandler('tow', function()
	...
	if isVehicleTow then
        ...
        TriggerEvent("pNotify:SendNotification",{text = "Din køretøj er ikke indregisteret som en flatbed",type = "error",timeout = (5000),layout = "centerRight",queue = "global",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
    end
end)
