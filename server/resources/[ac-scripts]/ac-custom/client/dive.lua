...
AddEventHandler('dive:water', function()
	...
	if IsEntityInWater(ped) then
		...
		TriggerEvent("pNotify:SendNotification",{text = "Du skal være i vandet før du kan tage dykker dragt på.",type = "success",timeout = (2000),layout = "centerRight",queue = "global",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"},killer = true})  	  
	end
end)
...
AddEventHandler('cn:dykkerdragt', function()
	...
	TriggerEvent("pNotify:SendNotification",{text = "Du tog dykkerdragten på.",type = "success",timeout = (2000),layout = "centerRight",queue = "global",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"},killer = true})  
end)
