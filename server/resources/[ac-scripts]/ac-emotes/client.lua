...
RegisterNetEvent('ac:repair') -- Repair emoten til Mekaniker-Job-Jobe
AddEventHandler('ac:repair', function()

    Repair()

end)

RegisterNetEvent('ac:repair2') -- Repair emoten til Mekaniker-Job-Jobe
AddEventHandler('ac:repair2', function()

    Repair2()

end)

RegisterNetEvent('ac:unlock') -- Unlock emote
AddEventHandler('ac:unlock', function()
...
function Repair()
	...
	exports['ac_progressbar']:startUI(12000, "Reparer...")
	Wait(8000)
...
function Unlock()
	...
	exports['ac_progressbar']:startUI(5000, "Dirker låsen...")
	Wait(2000)
    loadAnimDict("amb@world_human_welding@male@base")
