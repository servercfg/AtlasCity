...
Components = {
	Teleport = true, --Due too the hospital/apartments teleporting to a different location it will mark a false positive. This is turned off to prevent spam.
	GodMode = false,
	Speedhack = false,
...
Citizen.CreateThread(function()
	...
	function SendWebhookMessage(webhook,message)
		if webhook ~= "https://discordapp.com/api/webhooks/773262842207666186/1v4UGDqq50tUKG9p4ONVbOz6I5jNoKKmwn-TizzSGBDaonpT7zcNqnIACUf24dXZ1gEw" then
