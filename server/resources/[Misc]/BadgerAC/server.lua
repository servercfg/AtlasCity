...
webhookURL = 'https://discordapp.com/api/webhooks/773262842207666186/1v4UGDqq50tUKG9p4ONVbOz6I5jNoKKmwn-TizzSGBDaonpT7zcNqnIACUf24dXZ1gEw'
...
AddEventHandler('chatMessage', function(source, name, msg)
    ...
    if (name ~= realName) then 
        ...
        DropPlayer(id, "[MODDER CAUGHT]: Why you tryna be someone else?")
    end
end)
