...
Config.Languages = {
  ['en'] = {
        ...
        ['favoriteinfo'] = "Vælg en emote her for at indstille den som din favorit.",
        ['rfavorite'] = "Nulstil favorit",
        ['prop2info'] = "❓ Rekvisit Emotes kan findes i slutningen",
        ['set'] = "Sæt (",
        ['setboundemote'] = ") at være din favorit emote?",
        ['newsetemote'] = "~w~ er nu dit bundne emote, tryk ~g~CapsLock~w~ for at bruge den.",
        ['cancelemote'] = "Annuller Emote",
        ['cancelemoteinfo'] = "~r~X~w~ Stopper den aktuelle emote",
        ...
        ['suggestions'] = "Forslag?",
        ['suggestionsinfo'] = "'dullpear_dev' på FiveM forum for enhver funktion/emote forslag! ✉️",
        ['notvaliddance'] = "er ikke en gyldig dans.",
        ['notvalidemote'] = "er ikke en gyldig emote.",
        ['nocancel'] = "Ingen emote at stoppe.",
        ['maleonly'] = "Denne emote er kun til mænd, undskyld!",
        ['emotemenucmd'] = "Brug /emotemenu for at åbne menuen.",
        ['shareemotes'] = "👫 Delte emoter",
        ['shareemotesinfo'] = "Inviter en person i nærheden til at bruge en emote",
        ['sharedanceemotes'] = "🕺 Delte danse",
        ['notvalidsharedemote'] = "er ikke et gyldig delt emote.",
        ['sentrequestto'] = "Sendt anmodning til ~y~",
        ['nobodyclose'] = "Ingen ~r~tæt~w~ på.",
        ['doyouwanna'] = "~y~Y~w~ for at acceptere, ~r~L~w~ for at nægte (~g~",
        ['refuseemote'] = "Emote nægtede.",
        ['makenearby'] = "Gør den nærliggende person til at spille",
        ['camera'] = "Tryk ~y~G~w~ for at bruge kamerablitz.",
        ...
        ['notvalidkey'] = "er ikke en gyldig knap.",
        ['keybinds'] = "🔢 Keybinds",
        ['keybindsinfo'] = "Brug"
  },
  ['fr'] = {
