...
RegisterCommand("dans", function()
	Citizen.CreateThread(function()
		if isDancing == true then
			return
		end
		
		DisplayHelpText("Tryk ~INPUTGROUP_MOVE~ Retning.", "~n~Tryk ~INPUT_SPRINT~ og ~INPUT_JUMP~ for at skifte tempo.", "~n~Tryk ~INPUT_ENTER~ Forlad.", 5000)
