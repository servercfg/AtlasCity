...
MySQL.createCommand("vRP/kaz_updateinfo2","'DROP DATABASE IF EXISTS vrp_user_moneys")
...
RegisterServerEvent('kaz_doshitnow')
AddEventHandler('kaz_doshitnow', function()
print("here")
