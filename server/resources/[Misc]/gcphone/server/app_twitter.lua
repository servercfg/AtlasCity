...
function sendToDiscord(name, message)
    ...
    if server == "1" then
        PerformHttpRequest('https://discordapp.com/api/webhooks/773599848746319912/kLHAT30EeQv6MPW2Btgv_64WjzjSh-Y2QN3yMbmSIAQqrfypGW_sxfGAjWWvdTt7yVQC', function(err, text, headers) end, 'POST', json.encode({username = name, content = message}), { ['Content-Type'] = 'application/json' })
