...
AddEventHandler('service:startCall', function (number, message, coords)
    ...
    if number == "Politi-Job" or number == "EMS-Job" then
        vRP.getUserIdentity({user_id, function(identity)
            local discord = "https://discordapp.com/api/webhooks/773263769220546590/DbXTVfutL-0Q05GltH30wLYFm6r-yK491zej3jlGmKB0u1R5LGomBjtNCYyqDh1mUdWO"
            if number == "EMS-Job" then
                discord = "https://discordapp.com/api/webhooks/773263769220546590/DbXTVfutL-0Q05GltH30wLYFm6r-yK491zej3jlGmKB0u1R5LGomBjtNCYyqDh1mUdWO"
            end
