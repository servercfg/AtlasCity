...
function UTK:Plant()
    ...
    exports['ac_progressbar']:startUI(4500, Config.text.thermal)
    Citizen.Wait(1500)
    ...
    Citizen.Wait(4000)
    exports['ac_progressbar']:startUI(12000, Config.text.burning)
    DeleteObject(bag)
...
function UTK:Lockpick()
    ...
    exports['ac_progressbar']:startUI(6000, Config.text.lockpick..": "..Config.text.stage.." 1")
    Citizen.Wait(6500)
    exports["mythic_notify"]:SendAlert("inform", Config.text.stage.." 1 "..Config.text.stage_complete)
    SetEntityCoords(ped, loc.x, loc.y, loc.z, 1, 0, 0, 1)
    SetEntityHeading(ped, loc.h)
    TaskPlayAnim(ped, animDict, "a_uncuff", 8.0, 8.0, 6000, 1, 1, 0, 0, 0)
    exports['ac_progressbar']:startUI(6000, Config.text.lockpick..": "..Config.text.stage.." 2")
    Citizen.Wait(6500)
...
function UTK:IdCard()
    ...
    exports['ac_progressbar']:startUI(2000, Config.text.card)
    Citizen.Wait(1500)
    ...
    elseif self.currentid == 2 then
        ...
        UTK.disableinput = false
        exports['ac_progressbar']:startUI(4000, Config.text.using)
        local count = 4
        repeat
            Citizen.Wait(1000)
            count = count - 1
...
function Search(location)
    ...
    exports['ac_progressbar']:startUI(15000, Config.text.search)
    Citizen.Wait(15000)
...
function Process(ms, text) exports['ac_progressbar']:startUI(ms, text) Citizen.Wait(ms) end
...
AddEventHandler("utk_oh:policenotify", function(toggle)
        if toggle == 1 then
            exports["mythic_notify"]:SendAlert("infrom", "National Bankens alarm er udløst!", 10000, {["background-color"] = "#CD472A", ["color"] = "#ffffff"})
