...
Citizen.CreateThread(function ()
    while true do
        ...
        local distance = GetDistanceBetweenCoords(item.x, item.y, item.z,  plyCoords["x"], plyCoords["y"], plyCoords["z"], true)
            ...
            TriggerServerEvent('znowy_drugs:start2')
...
Citizen.CreateThread(function ()
    while true do
        ...
        local distance = GetDistanceBetweenCoords(item.x, item.y, item.z,  plyCoords["x"], plyCoords["y"], plyCoords["z"], true)
            ...
            Citizen.Wait(18000)
            ClearPedTasksImmediately(GetPlayerPed(-1))
            TriggerServerEvent('znowy_drugs:start3')
            FreezeEntityPosition(PlayerPedId(), false)
            Wait(1)
            start = true
            end
...
Citizen.CreateThread(function ()
    while true do
        ...
        local distance = GetDistanceBetweenCoords(item.x, item.y, item.z,  plyCoords["x"], plyCoords["y"], plyCoords["z"], true)
            ...
            Citizen.Wait(2000)
            ClearPedTasksImmediately(GetPlayerPed(-1))
            TriggerServerEvent('znowy_drugs:omdan')
            FreezeEntityPosition(PlayerPedId(), false)
            Wait(1)
            omdan2 = true
            end
...
Citizen.CreateThread(function ()
    while true do
        ...
        local distance = GetDistanceBetweenCoords(item.x, item.y, item.z,  plyCoords["x"], plyCoords["y"], plyCoords["z"], true)
            ...
            Citizen.Wait(18000)
            ClearPedTasksImmediately(GetPlayerPed(-1))
            TriggerServerEvent('znowy_drugs:omdan2')
            FreezeEntityPosition(PlayerPedId(), false)
            Wait(1)
            omdan = true
            end
...
--[[Citizen.CreateThread(function ()
    while true do
        ...
        local distance = GetDistanceBetweenCoords(item.x, item.y, item.z,  plyCoords["x"], plyCoords["y"], plyCoords["z"], true)
            ...
            Citizen.Wait(10000)
            ClearPedTasksImmediately(GetPlayerPed(-1))
            TriggerServerEvent('znowy_drugs:salg')
            FreezeEntityPosition(PlayerPedId(), false)
           end
          end
        end
