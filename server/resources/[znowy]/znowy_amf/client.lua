...
Citizen.CreateThread(function ()
    while true do
        ...
        local distance = GetDistanceBetweenCoords(item.x, item.y, item.z,  plyCoords["x"], plyCoords["y"], plyCoords["z"], true)
            ...
            TriggerServerEvent('znowy_drugs:startamf2')
...
Citizen.CreateThread(function ()
    while true do
        ...
        local distance = GetDistanceBetweenCoords(item.x, item.y, item.z,  plyCoords["x"], plyCoords["y"], plyCoords["z"], true)
            ...
            Citizen.Wait(18000)
            ClearPedTasksImmediately(GetPlayerPed(-1))
            TriggerServerEvent('znowy_drugs:startamf3')
            FreezeEntityPosition(PlayerPedId(), false)
            Wait(1)
            start = true
            end
...
Citizen.CreateThread(function ()
    while true do
        ...
        local distance = GetDistanceBetweenCoords(item.x, item.y, item.z,  plyCoords["x"], plyCoords["y"], plyCoords["z"], true)
            ...
            Citizen.Wait(2000)
            ClearPedTasksImmediately(GetPlayerPed(-1))
            TriggerServerEvent('znowy_drugs:omdanamf')
            FreezeEntityPosition(PlayerPedId(), false)
            Wait(1)
            omdan2 = true
            end
...
Citizen.CreateThread(function ()
    while true do
        ...
        local distance = GetDistanceBetweenCoords(item.x, item.y, item.z,  plyCoords["x"], plyCoords["y"], plyCoords["z"], true)
            ...
            Citizen.Wait(18000)
            ClearPedTasksImmediately(GetPlayerPed(-1))
            TriggerServerEvent('znowy_drugs:omdan2amf')
            FreezeEntityPosition(PlayerPedId(), false)
            Wait(1)
            omdan = true
            end
...
--[[Citizen.CreateThread(function ()
    while true do
        ...
        local distance = GetDistanceBetweenCoords(item.x, item.y, item.z,  plyCoords["x"], plyCoords["y"], plyCoords["z"], true)
            ...
            Citizen.Wait(10000)
            ClearPedTasksImmediately(GetPlayerPed(-1))
            TriggerServerEvent('znowy_drugs:salgamf')
            FreezeEntityPosition(PlayerPedId(), false)
           end
          end
        end
